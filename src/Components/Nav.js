                        ...
                        <div class="collapse navbar-collapse" id="navbarNavDropdown">
                            <ul className="navbar-nav ms-auto me-5">
                                <li className="nav-item text-secondary">
                                    <a href="/home" className="nav-link fw-semibold btn btn-outline-secondary  border border-dark border-1 active">Home</a>
                                </li>
                                <li className="nav-item text-secondary">
                                    <a href="#about" className="nav-link fw-semibold">About</a>
                                </li>
                                <li className="nav-item text-secondary">
                                    <a href="/Reserve" className="nav-link  fw-semibold ">Reservation</a>
                                </li>
                                <li className="nav-item text-secondary">
